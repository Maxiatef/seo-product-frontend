            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-2xl font-bold mb-4 text-transparent bg-gradient-to-r from-[#2A16DE] to-[#B526D1] bg-clip-text">ATTRACT</h3>
                        <p className="text-gray-300 mb-4">
                            Your one-stop shop for high-performance gaming gear. Elevate your gaming experience with our premium products.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/#products" className="text-gray-300 hover:text-purple-400 transition-colors">Products</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="text-gray-300 hover:text-purple-400 transition-colors">Shipping</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-purple-400 transition-colors">Returns</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-purple-400 transition-colors">Warranty</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-700 mt-8 pt-8 text-center">
                    <p className="text-gray-400">
                        &copy; 2025 ATTRACT Gaming Gear. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
